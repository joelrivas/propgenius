"""Aplicación Streamlit para generar prompts de venta inmobiliaria usando Gemini API."""
...
property_chars = st.text_area("Características Clave (Ej: 3 recámaras, terraza, seguridad 24h.)")
